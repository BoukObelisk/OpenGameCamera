...
KeyDef Keys::cameraForward = { "W", VK_GAMEPAD_LEFT_THUMBSTICK_UP };
KeyDef Keys::cameraBack = { "S", VK_GAMEPAD_LEFT_THUMBSTICK_DOWN };
KeyDef Keys::cameraLeft = { "A", VK_GAMEPAD_LEFT_THUMBSTICK_LEFT };
KeyDef Keys::cameraRight = { "D", VK_GAMEPAD_LEFT_THUMBSTICK_RIGHT };
...
KeyDef Keys::fovIncrease = { "+", VK_GAMEPAD_LEFT_THUMBSTICK_BUTTON };
KeyDef Keys::fovDecrease = { "-", VK_GAMEPAD_RIGHT_THUMBSTICK_BUTTON };
